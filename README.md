...
A token is used for authentication / security. They are used so that not any random person can access information inside an app.


- [x] What steps can you take in your web apps to keep your data secure?

Login with authentication and private routes.

- [x] Describe how web servers work.

Web servers take requests from clients (such as web browsers) and transfer information using the HTTP protocol. Generally, HTML documents are included in the information that is delivered to the client which may include styling sheets and scripts.
